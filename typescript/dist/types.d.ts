...
export type PartUserData = WallUserData | SlabUserData | ColumnUserData | BeamUserData | DoorUserData | WindowUserData | CoveringUserData | RailingUserData | StairUserData | StairMemberUserData;
...
export interface SchemeSpatial {
    ...
    /** DH 공용 홀 — {level: ring[]}. 코어 복도 띠를 양옆으로 늘인 팔·EV 로비(연희 75-9 GT T자 홀 —
     *  코어로 갈라진 2조각이라 링 목록). 세대에서 차감된 공용, 접면 연결계 = 코어 복도 ∪ 홀 */
