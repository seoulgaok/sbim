...
export class GeoCoordinateTransformer {
     ...
     */
    constructor(originLat, originLng, scale = 1.0) {
     ...
     */
    getMapAlignedScale(mapWidth, mapHeight, zoom) {
        // 타일 크기 (픽셀)
        const TILE_SIZE = 256;
     ...
     */
    createAlignmentMatrix(mapFloorWidth, mapZoom) {
...
//# sourceMappingURL=GeoCoordinateTransformer.js.map